...
module.exports = {
    ...
    SESSION: process.env.PIKKU_SESSION === undefined ? '' : process.env.PIKKU_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By PIKKU MON' : process.env.ALL_CAPTION,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  *ᴘɪᴋᴋᴜ ᴍᴏɴ*  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    SUPPORT: "98086567984-1612300121",
    SUPPORT2: "90000000000-1617736751",
    SUPPORT3: "90000000000-1621015274"
};
